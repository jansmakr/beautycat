...
- `.github/workflows/update-rss.yml` - RSS 피드 URL 및 제목 변경

#### ✅ 변경된 이미지 파일
- `images/beautycat-logo-v3.png` → `images/beautyket-logo-v3.png`
- `images/beautycat-logo-new.png` → `images/beautyket-logo-new.png`
- `images/beautycat-logo.png` → `images/beautyket-logo.png`
- `images/beautycat-logo-v2.png` → `images/beautyket-logo-v2.png`
- `images/beautycat-cat-emoji.png` → `images/beautyket-cat-emoji.png`
