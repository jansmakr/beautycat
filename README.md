...
- **현재 버전**: v2.8.13.6.48 (공지바 중앙정렬 + UI 최적화)
- **마지막 업데이트**: 2025-12-19
- **상태**: 🟢 프로덕션 운영 중
...
## 🚀 최근 업데이트 (v2.8.13.6.48)

### 2025-12-19 공지바 중앙정렬 + UI 최적화 (v2.8.13.6.48) 🎨
**"화면 중앙 배치 + 점 인디케이터 + 샵 이벤트 텍스트" ✅**:

1. **핵심 변경** 🎯:
   - ✅ **공지바 중앙 배치**: 모바일/데스크탑 모두 `max-w-4xl mx-auto` 적용 → 화면 중앙 고정
...
2. **레이아웃 개선** 🎨:
   ```html
   <!-- 모바일 & 데스크탑 공통 구조 -->
   <div class="max-w-4xl mx-auto">  <!-- 중앙 정렬 -->
...
3. **사용자 피드백 반영** ✅:
   - "공지바가 화면 중앙에 와야 함" → `max-w-4xl mx-auto` 적용
...
5. **효과** 🎉:
   - 🎯 **시각적 균형**: 화면 중앙 배치로 좌우 여백 균등
   - 🎨 **세련된 UI**: 점 인디케이터로 깔끔한 디자인
   - 📱 **모바일 친화**: 로고 크기 최적화로 가독성 향상
   - ⚡ **일관성**: 모든 UI 요소 높이 36px로 통일
