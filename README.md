...
## 📋 프로젝트 정보
- **프로젝트명**: BeautyCat (뷰티캣)
- **버전**: v2.6.4.9 🔥 (Phase 1: 빈자리 알림 시스템)
- **최종 업데이트**: 2025-12-11
- **상태**: ✅ **Production - 운영 중**
...
### v2.6.4.9 (2025-12-11) 🔥 **Phase 1: 빈자리 알림 시스템**
**🎯 빈자리 알림 핵심 기능 구현 (견적 증대 전략)**
- ✅ `shop_announcements` 테이블 확장: `category`, `event_type`, `slots_info` 필드 추가
- ✅ 샵 대시보드: 빈자리 등록 UI 추가 (날짜/시간/긴급도/할인율)
- ✅ 견적 상담 폼: "☑️ 오늘/내일 긴급 예약 희망" 체크박스 추가
- ✅ 빈자리 카테고리: 일반공지, 빈자리알림, 이벤트, 할인
- ✅ 긴급도 옵션: 일반, 오늘 빈자리, 긴급(2시간 이내)
...
**수정 파일:**
- `shop-dashboard.html` - Line 558-596 (빈자리 등록 폼 추가)
- `js/shop-dashboard.js` - Line 2441-2468, 2492-2510 (빈자리 데이터 수집 및 저장)
- `js/slots-info-toggle.js` - 신규 생성 (빈자리 섹션 토글)
