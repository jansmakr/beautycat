...
- **현재 버전**: v2.8.13.6.62 (2025 UI/UX 대규모 리디자인)
- **마지막 업데이트**: 2025-12-21
- **상태**: 🟢 프로덕션 운영 중
...
2. **Z-pattern 시선 유도**:
   - ✅ Social Proof (상단) → CTA 버튼 (중앙) → Hero (하단)
   - ✅ 자연스러운 흐름

3. **CTA 버튼 강조**:
   - ✅ 주요 버튼: 100px 높이, 500px 최대 너비
   - ✅ 폰트: 2xl/4xl (모바일/데스크탑)
   - ✅ 그림자: 0 8px 32px rgba
