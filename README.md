...
### ✅ 신규 샵 등록 - 완전 수정 완료! (2026-01-09)

**v2.8.8.1.6 shop_name 컬럼 오류 수정**
- ✅ **shop_name 필드 제거** - skincare_shops 테이블에 존재하지 않는 컬럼 제거
- ✅ **이메일 중복 체크** - 기존 사용자 확인 로직 추가 (v2.8.8.1.5)
- ✅ **신규 샵 등록 정상 작동** - 미료쿠 샵 등록 가능! 🎉
- 📦 **상세 문서**: HOTFIX_SHOP_NAME_COLUMN_v2.8.8.1.6.md 참고

**v2.8.8.1.5 이메일 중복 처리**
- ✅ **이메일 중복 체크** 추가 - 기존 사용자 있으면 재사용
- ✅ **사용자 등록 500 에러** 해결
