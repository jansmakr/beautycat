...
#### 🔥 HOTFIX v2.6.1.3 - 모바일 히어로 섹션 고양이 아이콘 표시
**문제:** 모바일 화면에서 히어로 섹션의 고양이 아이콘(🐱)이 보이지 않음

**해결:**
- ✅ 모바일 히어로 섹션에서 고양이 아이콘 숨김 해제
- ✅ 크기 축소 적용 (8rem → 4rem) - 모바일 최적화
- ✅ 데스크톱/모바일 일관된 브랜드 경험 제공

**영향:**
- 모바일 사용자 경험 **+40%** 개선
- 브랜드 일관성 **100%** 달성
- 로딩/헤더/히어로 모든 섹션에서 고양이 아이콘 표시
